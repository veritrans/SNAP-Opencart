	...
	<div class="form-group required v2_settings sensitive">
	  <label class="col-sm-2 control-label" for="input-merchant-id"><?php echo $entry_bank; ?></label>
		<div class="col-sm-3">
		  ...
		  <span>fill with acquiring one bank name lowercase. e.g : bca or bri</span>
		</div>
		<div class="col-sm-3">
		 <?php if (isset($error['bank'])) { ?>
		   <div class="col-sm-3"> <?php echo $error['bank']; ?> </div>
		 <?php } ?>
		</div>
	</div>
	<!-- bank -->
	  ...
	  <div class="col-sm-3">
	   <select name="snapmigs_geo_zone_id"  class="form-control">
		...
		<?php foreach ($geo_zones as $geo_zone) { ?>
		  <?php if ($geo_zone['geo_zone_id'] == $snapmigs_geo_zone_id) { ?>
